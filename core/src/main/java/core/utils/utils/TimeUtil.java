...
public class TimeUtil {
    ...
    public static String getTimeNoss(long date) {
        long ss = date / 1000 / 60 % 60;
        long hh = date / 1000 / 60 / 60;
        if (hh > 0) {
            return hh + ":" + ss;
        }
        return "00:" + ss;
     ...
     * @return
     */
    public static String getYearBySubstring(String date) {
     ...
     * @return
     */
    public static String getMonthBySubstring(String date) {

        return date.substring(5, 10);
    }

    /**
     * 时间日期字符串分割得到XX:XX:XX时间
     *
     * @param date
     * @return
     */
    public static String getTimeBySubstring(String date) {
